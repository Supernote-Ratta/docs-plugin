...
| 翻转套索元素 | [`flipLassoElements(flipType)`](/zh/api-reference/supernote-plugin/plugin-comm-api/flip-lasso-elements) | 翻转当前套索中的支持元素，`1` 为水平翻转，`2` 为垂直翻转 |
...
- `flipLassoElements` 仅支持翻转笔划和几何图形，且当前只支持水平和垂直翻转
