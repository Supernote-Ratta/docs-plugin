...
| `penColor` | `number` | Pen color: `0` (`0x00`) black, `157` (`0x9D`) dark gray, `201` (`0xC9`) light gray, `254` (`0xFE`) white |
| `penType` | `number` | Pen type: `10` technical pen, `16` pressure pen, `11` marker pen, `15` calligraphy |
